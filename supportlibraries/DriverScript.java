...
public class DriverScript {
	...
	private void initializeTestReport() {
		...
		report.addTestLogSubHeading("Date & Time", ": " + Util.getCurrentFormattedTime(properties.getProperty("DateFormatString")), "Iteration Mode", ": " + testParameters.getIterationMode());
		...
		if(gridMode.equalsIgnoreCase("on")) {
			...
			report.addTestLogSubHeading("Platform", ": " + testParameters.getPlatform().toString(), "Application URL", ": " + properties.getProperty("ApplicationUrl"));
		} else {
			report.addTestLogSubHeading("Browser", ": " + testParameters.getBrowser(), "Application URL", ": " + properties.getProperty("ApplicationUrl"));
		}
	...
	private ArrayList<String> getBusinessFlow() {
		ExcelDataAccess businessFlowAccess = new ExcelDataAccess(frameworkParameters.getRelativePath() + Util.getFileSeparator() + "Datatables", testParameters.getCurrentScenario());
		...
		while (true) {
			String dataValue = businessFlowAccess.getValue(rowNum, currentColumnNum);
			if (dataValue.equals("")) {
				break;
			}
	 ...
	 */
	private void executeTestcase(ArrayList<String> businessFlowData) throws IllegalArgumentException,
	 ...
	 * @throws InstantiationException
	 */
	private void invokeBusinessComponent(String currentKeyword) throws IllegalArgumentException,
			IllegalAccessException, InvocationTargetException, ClassNotFoundException, InstantiationException {
